<template>
  <section class="text-xs md:text-header-window">
    ...
    <ul class="list-disc ml-3">
      ...
      <li>{{ $t('project.gameAssetAiAgent.goalThird') }}</li>
      <li>{{ $t('project.gameAssetAiAgent.goalFourth') }}</li>
    ...
    <div class="mt-5 mb-2">
      <p class="font-semibold italic text-gray-500 mb-2">{{ $t('project.gameAssetAiAgent.tasksDoneSecond') }}</p>
      <p class="mb-2">{{ $t('project.gameAssetAiAgent.tasksDoneSecondDetails') }}</p>
    </div>
    <div class="mt-5 mb-2">
      <p class="font-semibold italic text-gray-500 mb-2">{{ $t('project.gameAssetAiAgent.tasksDoneThird') }}</p>
      <p class="mb-2">{{ $t('project.gameAssetAiAgent.tasksDoneThirdDetails') }}</p>
    </div>
    <div class="mt-5 mb-2">
      <p class="font-semibold italic text-gray-500 mb-2">{{ $t('project.gameAssetAiAgent.tasksDoneFourth') }}</p>
      <p class="mb-2">{{ $t('project.gameAssetAiAgent.tasksDoneFourthDetails') }}</p>
    </div>
    <div class="w-full text-xs justify-center mt-5 mb-2 flex flex-row items-center gap-0.5 cursor-pointer transition-all hover:underline hover:text-heroic-blue hover:fill-heroic-blue">
      ...
      <a rel="noopener" href="https://github.com/yonisabag11/game-asset-ai-agent" target="_blank" class="cursor-pointer">{{$t('buttons.linkRepository') }}</a>
    </div>
